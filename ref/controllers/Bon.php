...
class Bon extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('client/page/bon', $data);
	...
	public function riwayat()
	{
		$user = $this->thisUser();
		$id = $user[0]['user_id'];
		$data['list_bon'] = $this->get_bon($id);
		$this->load->view('client/partial/header');
		$this->load->view('client/page/bon-riwayat', $data);
		$this->load->view('client/partial/footer');
	}
	...
	public function detail()
	{
		...
		$this->load->view('client/partial/header');
		$this->load->view('client/page/bon-detail', $data);
		$this->load->view('client/partial/footer');

	}

	public function get_bon($id)
	{
		$q = $this->Model_bon->get_all_data_by_user($id);
		return $q;
	}
	...
	public function thisUser()
	{
		...
		$user = $this->session->userdata('client_ebonpas');
...
/* End of file Bon.php */
/* Location: ./application/controllers/client/Bon.php */